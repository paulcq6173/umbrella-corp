...
const Archives = () => {
  ...
  const limit: number = mobileMode ? 5 : 10;
  ...
  return (
    <div className="w-screen h-fit bg-black">
      ...
      <div className="relative h-dvh">
        ...
        <div className="absolute w-11/12 h-fit top-8 left-2 sm:left-4 bg-gray-400 opacity-80">
          {Docs.map(
            (doc, index) =>
          ...
          <div className="flex justify-center gap-2">
            ...
            <button
              className={`absolute text-white left-4 sm:left-12 lg:left-20 drop-shadow ${
                !hasPrev && 'hidden'
              } `}
              value="prev"
              onClick={turnToPage}
            ...
            <button
              className={`absolute text-white right-4 sm:right-12 lg:right-20 drop-shadow ${
                !hasNext && 'hidden'
              }`}
              value="next"
              onClick={turnToPage}
