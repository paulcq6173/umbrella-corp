...
const documents = {
    ...
    "\n  \n  \n  query getAllProductsQuery ($searchKeyword: String, $first: Int, $after: String, $orderDirection: OrderDirection, $orderBy: AllProductsOrderBy) {\n    allProducts (searchKeyword: $searchKeyword, first: $first, after: $after, orderDirection: $orderDirection, orderBy: $orderBy) {\n      edges {\n        node {\n          ...productFields\n        }\n        cursor\n      }\n      pageInfo {\n        ...pageInfoFields\n      }\n    }\n  }\n": types.GetAllProductsQueryDocument,
