...
export type Query = {
  ...
  allProjects?: Maybe<Array<Maybe<BowProject>>>;
...
export type BowFieldsFragment = {
  ...
  imgUrl: string;
} & { ' $fragmentName'?: 'BowFieldsFragment' };
...
export type LoginMutation = {
  __typename?: 'Mutation';
  login?: { __typename?: 'Token'; value: string } | null;
};
...
export type GetLoggedInUserQuery = {
  __typename?: 'Query';
  me?: { __typename?: 'User'; username: string } | null;
};
...
export type FindProjectQueryQuery = {
  __typename?: 'Query';
  findProjectById?:
    | ({ __typename?: 'BOWProject' } & {
        ' $fragmentRefs'?: { ProjectFieldsFragment: ProjectFieldsFragment };
  ...
  definitions: [
    {
      ...
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'gtin' } },
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'imgUrl' } },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'pulishedDate' },
                },
              ],
            },
          },
...
export const BowFieldsFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'bowFields' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'BOW' },
      },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'based' } },
          { kind: 'Field', name: { kind: 'Name', value: 'height' } },
          { kind: 'Field', name: { kind: 'Name', value: 'mass' } },
          { kind: 'Field', name: { kind: 'Name', value: 'createdVia' } },
          { kind: 'Field', name: { kind: 'Name', value: 'characteristics' } },
          { kind: 'Field', name: { kind: 'Name', value: 'experimentalType' } },
          { kind: 'Field', name: { kind: 'Name', value: 'massProducted' } },
          { kind: 'Field', name: { kind: 'Name', value: 'imgUrl' } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<BowFieldsFragment, unknown>;
  ...
  definitions: [
    {
      ...
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'BOWProject' },
      },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'description' } },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'experimentalType' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'massProducted' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'imgUrl' } },
              ],
            },
...
>;
export const GetAllProductsQueryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getAllProductsQuery' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        },
        {
          ...
          type: {
            kind: 'NamedType',
            name: { kind: 'Name', value: 'AllProductsOrderBy' },
          },
        },
      ],
      selectionSet: {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'allProjectsQuery' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
>;
export const FindProjectQueryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'findProjectQuery' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  FindProjectQueryQuery,
  FindProjectQueryQueryVariables
>;
